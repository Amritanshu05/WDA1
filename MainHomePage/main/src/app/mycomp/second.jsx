...
const Second = () => {
  return (
    <div>
      <div className="w-screen h-auto  bg-amber-50 ">
        ...
        <div className="w-screen h-screen  bg-amber-50 flex flex-wrap justify-center mt-5  space-x-5  pl-5 pr-5  ">
          <div className="card card-compact  w-1/5  h-96 glass ">
  ...
  <div className="card">
    <figure >
      ...
      <div className="pb-16 bg-amber-50">
