    ...
    <div>
      <div className="navbar bg-amber-50 text-black fixed z-50">
        ...
        <div className="flex-none gap-2">
          ...
          <div className="pl-2">
            {/* <button onClick={handleViewCart} className="btn btn-ghost btn-circle "> */}
              <div className="indicator">
                ...
                {/* <span className="badge badge-xs badge-primary indicator-item">{itemCount}</span> */}
              </div>
            {/* </button> */}
          </div>
              ...
              <div className="indicator">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth="2"
                    d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0 2 2 0 010 4zm-8 2a2 2 0 100-4 2 2 0 000 4z"
                  />
                </svg>
